...
""" eversprind temperature moisture low-level interface.
...
REG_MOISTURE = ZWaveRegister(0,49,5)


class ST814Instrument(Loggable):
    ...
    def poll(self):
        ...
        raw_temperature = self.read_freg(REG_TEMPERATURE)
        raw_moisture = self.read_freg(REG_MOISTURE)
